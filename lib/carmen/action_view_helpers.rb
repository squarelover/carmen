    ...
    module FormOptionsHelper
      ...
      def country_options_for_select(selected = nil, *priority_country_codes)
        ...
        unless priority_country_codes.empty?
          priority_countries = Carmen.country_data.select do |pair| name, code = pair
        ...
        return country_options + options_for_select(Carmen.country_data, priority_country_codes.include?(selected) ? nil : selected)
      end
    end
